...
<head>
    ...
    flex-shrink: 0;
        ...
        /* Select2: que el texto salga en varias líneas si es largo */
...
<div class="d-flex">
    ...
    <nav class="nav flex-column mt-3">
        ...
        <!-- 5. Administración del Sistema (solo admin) -->
        @if(Auth::user() && Auth::user()->role == 'admin')
            <div class="text-white-50 text-uppercase small mt-3 ms-1">Administración del Sistema</div>
